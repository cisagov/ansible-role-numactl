...
issue](https://github.com/cisagov/ansible-role-numactl/issues) in this
...
request](https://github.com/cisagov/ansible-role-numactl/pulls), you
...
```bash
cd ansible-role-numactl
pyenv virtualenv <python_version_to_use> ansible-role-numactl
pyenv local ansible-role-numactl
